...
function displayHTMLHeadPages()
{
    ...
    {
        $lastname = $lastnameError = $pictureError = $description = $descriptionError = $firstname = $firstnameError = $phone = $phoneError = $email = $emailError = $password = $passwordError = $verifPassword = $verifPasswordError = $street = $streetError = $zipcode = $zipcodeError = $city = $cityError = "";
    ?>
        <div class="container">
            <form action="inscription.php" class="form formRegister" method="POST" role="form" enctype="multipart/form-data">
                <div class="row divFormRegister">
                    ...
                    <div class="col-md-6 col-sm-12 formRegisterLeft">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="phone_number" name="phone_number" placeholder="" value="<?php echo $phone; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="verifPassword" name="verifPassword" placeholder="" value="<?php echo $verifPassword; ?>">
                            <span class="help-inline"><?php echo $verifPasswordError; ?></span>
                        </div>
                        <div class="form-group">
                            <label for="street">Adresse (Numéro inclus) :</label>
                            <input type="text" class="form-control" id="street" name="street" placeholder="" value="<?php echo $street; ?>">
                            <span class="help-inline"><?php echo $streetError; ?></span>
                        </div>
                        <div class="form-group">
                            <label for="zipcode">Code postal :</label>
                            <input type="int" class="form-control" id="zipcode" name="zipcode" placeholder="" value="<?php echo $zipcode; ?>">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label for="housing_type">Type d'habitation :</label> <br>
                            <input type="checkbox" name="housing_type" id="housing_type" value="Maison"> Maison <br>
                            <input type="checkbox" name="housing_type" id="housing_type" value="Appartement"> Appartement <br>
                        </div>
                        <div class="form-group">
                            <label for="animals">Je possède des animaux :</label> <br>
                            <input type="checkbox" name="animals" id="animals" value="Oui"> Oui <br>
                            <input type="checkbox" name="animals" id="animals" value="Non"> Non <br>
                        </div>
                        <div class="form-group">
                            <label for="description">Courte description :</label> <br>
                            <textarea name="description" id="description" cols="30" rows="10" maxlength="255"><?php echo $description; ?></textarea>
